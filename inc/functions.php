...
function mks_generate_fontawesome_icons_picker(){
 ...
 echo '<a href="#" class="mks_icon_pick_button button-secondary">Choose icon</a>';
 echo '<div class="mks_icon_data_preview"></div>';
 echo '<ul class="mks_icon_list">';
 echo '<p>Icons by <a href="http://fortawesome.github.com/Font-Awesome/" target="_blank">Font Awesome</a></p>';
 foreach($icons as $class => $icon){
 	echo '<li><a href="#" data-icon="'.$class.'"><i class="fa '.$class.'"></i></a></li>';
 }
 echo '</ul>';
 echo '</div>';
